...
int main(int argc, char **argv)
{
    const char *getRequest = 
        "GET /templets/new/script/jquery?user=1#fragment HTTP/1.1\r\n"
    ...
    http_request_parser_execute(&parser, getRequest, strlen(getRequest), 0);
    ...
    parser.http_field = on_request_http_field;
    parser.data = nullptr;
    http_request_parser_execute(&parser, postRequest, strlen(postRequest), 0);
    return 0;
}